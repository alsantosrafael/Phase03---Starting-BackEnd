...
for(let card of cards) {
    ...
    card.addEventListener("click", function() {
        const videoId = card.getAttribute("id")//pegando o atributo id do card para usar como endereco do video
        modalOverlay.classList.add('active')//adicionando classe active para o modal poder ser aberto
        modalOverlay.querySelector("iframe").src = `https://rocketseat.com.br/${videoId}`//iframe//to adicionando o endereco do video de forma dinamica
